...
public class EmailServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    try {
			...
			{
				out.print("{\"exists\":true,\"message\":\"Mobile no. already exists\"}");
				System.out.println("Mobile no");
			}
			else if (email) 
			{
				out.print("{\"exists\":true,\"message\":\"Email already exists\"}");
			...
			else 
			{
		    	...
		    	out.print("{\"exists\":true,\"message\":\"You email is currently blocked\"}");
		    }
	    }catch (Exception e) {
			e.printStackTrace();
		}
